<template>
  <div class="page">
    <div class="page-title">
      <h2>{{$t('message.title_authManagement')}}</h2>
    </div>
      ...
      <div class="page-shadow-content show-shadow">
        ...
        <div class="table-wrap">
          <el-table
            ...
            <el-table-column
              prop="roles"
              :label="$t('message.qt_auth')">
              <template slot-scope="scope">
                <el-popover trigger="hover" placement="top">
                  <p v-for="(index,item) in scope.authList" :key="index">{{item}}</p>
            ...
            <el-table-column
              ...
              width="150">
              <template slot-scope="scope">
                <el-button type="primary" size="mini" @click="handleEdit(scope.$index, scope.row)">{{$t('message.qt_change')}}</el-button>
                <el-button type="danger" size="mini"  @click="handleDelete(scope.$index, scope.row)">{{$t('message.qt_delete')}}</el-button>
              </template>
            </el-table-column>
          </el-table>
...
<script>
import AddForm from './AuthAddForm.vue'
import EditForm from './AuthEditForm.vue'
